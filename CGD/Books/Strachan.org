* Pedigrees
 ...
 - But no one to one correspondance bwteen transcriptional units and phenotypes for three types of heterogeneity:
   ...
   + Clinical heterogeneity :: Mutations in same gene -> two phenotypes -
     HPRT -> gout or Lesch-Nyhan syndrome (severe mental retardation)
    + Also, mutation in Androgen receptor -> AR insensitivity, female body,
      but trinucleotide repeat expansion -> spinobulbar muscular atrophy,
      Kennedy's disease
